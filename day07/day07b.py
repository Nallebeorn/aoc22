...
print(f"Of the directories large enough that deleting one of them would free up the space required for the update, {size_of_smallest_viable_deletion} is the size of the smallest.")
